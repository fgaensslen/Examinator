---
question: "You are developing an Azure SQL solution by using Microsoft Visual Studio 2026. The solution uses a GitHub repository.
...
- [x]the \.vscode\settings.json file that contains a URL of https://api.githubcopilot.com/mcp/
- [ ]the \.github\mcp.json file that contains the personal access token (PAT) that has the repo scope
